...
contract UpgradeMotifServiceManager is Script {
    ...
    address constant _MOTIF_STAKE_REGISTRY_PROXY = 0x2b50637B799e38Fc55596829DB1126A57681E012;

    function upgradeMotifServiceManager() public {
        // Deploy new implementation
        MotifServiceManager serviceManagerImpl =
            new MotifServiceManager(_AVS_DIRECTORY, _MOTIF_STAKE_REGISTRY_PROXY, _REWARDS_COORDINATOR, _DELEGATION_MANAGER);
        ...
        console.log("Motif Service Manager upgraded successfully");
