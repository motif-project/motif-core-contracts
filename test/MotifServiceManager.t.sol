...
contract MotifServiceManagerTest is Test {
    ...
    function testConfirmDeposit() public {
        ...
        vm.prank(testOwner);
        podManager.verifyBitcoinDepositRequest(podAddress, txId, amount);
        ...
        bytes32 messageHash = keccak256(abi.encodePacked(podAddress, operator, amount, txId, true));
    ...
    function testWithdrawBitcoinPSBT() public {
        ...
        bytes32 messageHash = keccak256(abi.encodePacked(podAddress, amount, psbtTx, withdrawAddress));
        bytes32 ethSignedMessageHash = messageHash.toEthSignedMessageHash();
    ...
    function testWithdrawBitcoinCompleteTx() public {
        ...
        bytes32 messageHash = keccak256(abi.encodePacked(podAddress, amount, completeTx, withdrawAddress));
        bytes32 ethSignedMessageHash = messageHash.toEthSignedMessageHash();
    ...
    function testConfirmWithdrawal() public {
        ...
        bytes32 messageHash = keccak256(abi.encodePacked(podAddress, transaction, withdrawAddress));
        bytes32 ethSignedMessageHash = messageHash.toEthSignedMessageHash();
